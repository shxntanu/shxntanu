...
- 🎵 Minima-List <a href="https://github.com/shxntanu/minima-list-ML">(Backend + ML)</a> <a href="https://github.com/shxntanu/minima-list">(Frontend)</a> (Get music recommendations based on the song that's currently occupying your mind)
